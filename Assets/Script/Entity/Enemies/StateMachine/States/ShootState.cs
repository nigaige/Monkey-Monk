...
namespace MonkeyMonk.Enemies.StateMachine
{
    public class ShootState : State
    {
        ...
        [Range(0.0f, 180.0f)]
        [SerializeField] private float shootAngleDeg = 90.0f;
        ...
        private IEnumerator Shoot()
        {
            ...
            proj.Initialize((Quaternion.Euler(0, 0, Entity.LookDirection * -shootAngleDeg) * Vector3.up).normalized * shootForce, Entity.gameObject);
